export default function Home() {
  return (
    <div className="container mx-auto bg-neutral-100 p-10 shadow-xl font-mono">
      <h1 className="text-slate-900 text-3xl font-extrabold mb-5">Popups Task</h1>
      <h3 className="text-lg text-slate-700">This project was implemented by<span className="text-slate-900"> Omar Abordn</span></h3>
